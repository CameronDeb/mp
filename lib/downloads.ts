...
export const DOWNLOAD_MANIFEST: Record<string, DownloadFile[]> = {
  becoming_skillfullyaware_workbook: [
    { key: "becoming_skillfullyaware_workbook/Becoming SkillfullyAware - See Yourself.pdf", filename: "Becoming SkillfullyAware - See Yourself.pdf" },
  ],
  unfinished_business_workbook: [
    { key: "unfinished_business_workbook/Unfinished Business - Understand Yourself.pdf", filename: "Unfinished Business - Understand Yourself.pdf" },
  ],
  raising_awareness_workbook: [
    { key: "raising_awareness_workbook/Raising Awareness - Evolve Yourself.pdf", filename: "Raising Awareness - Evolve Yourself.pdf" },
  ],
  power_tools_bundle: [
    { key: "becoming_skillfullyaware_workbook/Becoming SkillfullyAware - See Yourself.pdf", filename: "Becoming SkillfullyAware - See Yourself.pdf" },
    { key: "unfinished_business_workbook/Unfinished Business - Understand Yourself.pdf", filename: "Unfinished Business - Understand Yourself.pdf" },
  ...
  // Awaiting Maria's finished booklet (Mark, 31 Aug). Uncomment to
  // restore; the audio and the draft booklet are already in storage.
